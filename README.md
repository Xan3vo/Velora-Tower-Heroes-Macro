...
> [!CAUTION]
> The only official place to download Velora is this repository's [Releases page][latest-release-link]. Downloads from anywhere else may be tampered with.
...
1. Download `Tower-Heroes-Macro-Setup-#.#.#.exe` from the [latest release][latest-release-link]
